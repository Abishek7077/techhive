...
const TaskAdd = () => {
  ...
  <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 h-full bg-gradient-to-r from-violet-500 to-red-500 ">
    <div className="mb-4">
    ...
    <div className="flex items-center justify-between">
      <button className="transform h-10 bg-red-400 w-40 transition duration-500 hover:scale-125 hover:bg-violet-600 flex justify-center items-center rounded 2xl" type="button" onClick={() => addtask()}>
        Add Task
      </button>
    </div>
  </form>
  <button
  className="bg-red-500 text-white active:bg-violet-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 animate"
  type="button"
  onClick={() => setShowModal(true)}
>
  SHOW TASK 
</button>
<button  className="bg-violet-500 text-white active:bg-red-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 animate" 
  ...
  <tbody>
  {
      tasksList && tasksList.map((task,index) => {
        return(
          ...
          <button className="bg-red-500 hover:bg-violet-700 text-white font-bold py-2 px-4 rounded-full" onClick={() => updatetask(task)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
</svg>

          </button>
      </td>
      <td><button className="bg-violet-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full" onClick={() => deletetask(task)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
